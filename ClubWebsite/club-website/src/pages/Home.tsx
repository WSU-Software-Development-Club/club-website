      ...
      <main className="flex-grow">
        ...
        <section className="py-16 px-6">
          ...
          <div className="container mx-auto flex justify-center space-x-6 py-6">
            <a
              href="https://discord.com/invite/ZmcwBPUj9B"
              target="_blank"
            ...
            <a
              href="https://github.com/WSU-Software-Development-Club"
              target="_blank"
              rel="noopener noreferrer"
              className="text-crimson hover:text-black80 transition-colors"
            >
            ...
            <a
              href="https://www.instagram.com/sdc.wsu/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-crimson hover:text-black80 transition-colors"
            >
        ...
        <section
          className="bg-crimson w-full flex flex-col sm:flex-row justify-center 
